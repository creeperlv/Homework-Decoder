	...
	public ComProgramPro() {
		...
		lblDecode
				.setIcon(new ImageIcon(
						ComProgramPro.class
								.getResource("/com/Studio2048/HomeworkDecoder/Res/Button.png")));
		lblDecode.setBounds(341, 392, 123, 27);
		panel.add(lblDecode);
		...
		lblDecoder.setBounds(341, 420, 123, 27);
		...
		lblStop.setBounds(464, 392, 123, 27);
		panel.add(lblStop);
		...
		lblBugreport.setBounds(464, 420, 123, 27);
		...
		lblExit.setBounds(341, 448, 123, 27);
		panel.add(lblExit);
		...
		lblAbout.setBounds(464, 448, 123, 27);
		panel.add(lblAbout);
